...
construct_runtime! {
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		// Bounties module.
		Bounties: pallet_bounties::{Module, Call, Storage, Event<T>} = 36,

		// Tips module.
		Tips: pallet_tips::{Module, Call, Storage, Event<T>} = 37,

        // Contracts module.
        Contracts: pallet_contracts::{Module, Call, Config<T>, Storage, Event<T>} = 38,
	}
}
